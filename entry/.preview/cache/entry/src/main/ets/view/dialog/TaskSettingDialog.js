...
export class TargetSettingDialog extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("view/dialog/TaskSettingDialog.ets(63:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/dialog/TaskSettingDialog.ets(64:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/dialog/TaskSettingDialog.ets(66:9)");
            ...
            if ([taskType.getup, taskType.sleepEarly].indexOf((_a = this.settingParams) === null || _a === void 0 ? void 0 : _a.taskID) > Const.HAS_NO_INDEX) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        TimePicker.debugLine("view/dialog/TaskSettingDialog.ets(76:9)");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        TextPicker.debugLine("view/dialog/TaskSettingDialog.ets(85:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/dialog/TaskSettingDialog.ets(93:7)");
...
export class RemindTimeDialog extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("view/dialog/TaskSettingDialog.ets(125:5)");
            Column.justifyContent(FlexAlign.Center);
            Column.height(Const.THOUSANDTH_560);
            Column.padding(Const.DEFAULT_12);
            if (!isInitialRender) {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("view/dialog/TaskSettingDialog.ets(126:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TimePicker.debugLine("view/dialog/TaskSettingDialog.ets(135:7)");
            TimePicker.height(Const.THOUSANDTH_800);
            TimePicker.useMilitaryTime(true);
            TimePicker.onChange((value) => {
                this.currentTime = formatTime(value);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/dialog/TaskSettingDialog.ets(144:7)");
            Row.justifyContent(FlexAlign.SpaceAround);
            Row.width(Const.THOUSANDTH_1000);
            Row.height(Const.DEFAULT_28);
            Row.margin({ bottom: Const.DEFAULT_20 });
...
export class FrequencyDialog extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("view/dialog/TaskSettingDialog.ets(192:5)");
            Column.justifyContent(FlexAlign.Center);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("view/dialog/TaskSettingDialog.ets(193:7)");
            Column.width(Const.THOUSANDTH_900);
            if (!isInitialRender) {
                Column.pop();
            }
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("view/dialog/TaskSettingDialog.ets(204:11)");
                        if (!isInitialRender) {
                            ListItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
                    ...
                    const observedDeepRender = () => {
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                            Row.create();
                            Row.debugLine("view/dialog/TaskSettingDialog.ets(205:13)");
                            Row.width(Const.THOUSANDTH_1000);
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("view/dialog/TaskSettingDialog.ets(206:15)");
                            Text.fontSize(Const.DEFAULT_20);
                            if (!isInitialRender) {
                                Text.pop();
                            }
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Toggle.debugLine("view/dialog/TaskSettingDialog.ets(207:15)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/dialog/TaskSettingDialog.ets(226:7)");
            Row.justifyContent(FlexAlign.SpaceAround);
